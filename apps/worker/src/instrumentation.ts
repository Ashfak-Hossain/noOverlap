...
const sdk = new NodeSDK({
  resource: resourceFromAttributes({
    // This process is 'worker'; the API is 'api'. The distinct names are what make one booking two
  ...
  instrumentations: [
    getNodeAutoInstrumentations({
      ...
      // any job they arrive as standalone traces — thirty of them in five minutes from a worker with
      // nothing to do. That volume does not merely add noise: it buries the booking saga that this
